    ...
    <section id="productos" className="py-20 md:py-28 bg-slate-50/70 relative overflow-hidden">
      <div className="max-w-[1350px] mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-3xl mb-14">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-slate-200 shadow-sm mb-6 transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-brand-support text-base sm:text-lg">
            Soluciones SaaS desarrolladas por Gliro que ya resuelven problemas concretos en empresas reales.
          </p>
        </div>
