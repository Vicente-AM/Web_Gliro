...
export const testimonialsData: TestimonialItem[] = [
  ...
  },
  {
    ...
    role: "Gerencia",
    text: "La capacidad de Gliro para entender procesos técnicos complejos y transformarlos en software simple, robusto y confiable nos ha permitido optimizar nuestro flujo operativo diario.",
    rating: 5,
    avatar: "TDM",
  },
  {
    ...
    company: "Medplan",
    role: "Operaciones",
    text: "Automatizamos el flujo de información y la gestión de alertas de compras públicas, ahorrando cientos de horas hombre cada mes con soporte y atención continua.",
    rating: 5,
    avatar: "MP",
  },
];
